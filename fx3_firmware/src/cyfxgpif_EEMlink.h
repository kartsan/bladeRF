/*
 * Project Name: EEMlink.cyfx
 * Time : 05/13/2026 20:08:12
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
#ifndef _INCLUDED_CYFXGPIF2CONFIG_EEM_
#define _INCLUDED_CYFXGPIF2CONFIG_EEM_
#include "cyu3types.h"
#include "cyu3gpif.h"
 ...
 */
#define CY_EEMLINK_NUMBER_OF_STATES 6

/* Summary
   Mapping of user defined state names to state indices
 */
#define EEMLINK_START 0
#define EEMLINK_INIT 1
#define EEMLINK_IF_RX_1 3
#define EEMLINK_IF_TX_2 5
#define EEMLINK_DONE 4
#define EEMLINK_WAIT_0 2


/* Summary
   Initial value of early outputs from the state machine.
 */
#define EEMLINK_ALPHA_START 0x80


/* Summary
   Transition function values used in the state machine.
 */
uint16_t EEMlink_CyFxGpifTransition[]  = {
    0x0000, 0xCCCC, 0xAAAA, 0x5555, 0xFFFF
};
...
/* Summary
   ...
   waveform table. 
 */
CyU3PGpifWaveData EEMlink_CyFxGpifWavedata[]  = {
    {{0x4E739C01,0x00001000,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x1E704102,0x080100C4,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x3E739A05,0x08000000,0x80000000},{0x3E739A03,0x24000000,0x80000000}},
 ...
 */
uint8_t EEMlink_CyFxGpifWavedataPosition[]  = {
    0,1,2,3,1,3
};
 ...
 */
uint32_t EEMlink_CyFxGpifRegValue[]  = {
    ...
    0x0000FF79,  /*  CY_U3P_PIB_GPIF_CTRL_BUS_DEFAULT */
 ...
 */
const CyU3PGpifConfig_t EEMlink_CyFxGpifConfig  = {
    (uint16_t)(sizeof(EEMlink_CyFxGpifWavedataPosition)/sizeof(uint8_t)),
    EEMlink_CyFxGpifWavedata,
    EEMlink_CyFxGpifWavedataPosition,
    (uint16_t)(sizeof(EEMlink_CyFxGpifTransition)/sizeof(uint16_t)),
    EEMlink_CyFxGpifTransition,
    (uint16_t)(sizeof(EEMlink_CyFxGpifRegValue)/sizeof(uint32_t)),
    EEMlink_CyFxGpifRegValue
};
